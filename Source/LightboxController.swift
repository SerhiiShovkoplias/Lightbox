...
public protocol LightboxControllerPageDelegate: AnyObject {
    ...
    func lightboxController(_ controller: LightboxController, didPressleftButton: UIButton)
}
...
open class LightboxController: UIViewController {
    ...
    open func deleteCurrentPage(completion: @escaping (() -> Void)) {
...
extension LightboxController: HeaderViewDelegate {
    ...
    func headerView(_ headerView: HeaderView, didPressLeftButton leftButton: UIButton) {
        pageDelegate?.lightboxController(self, didPressleftButton: leftButton)
    }
